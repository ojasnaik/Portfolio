...
const SkillsSection: React.FC = () => {
  const skillCategories = [
    ...
    },
    {
      ...
      skills: ["Git", "GitHub", "Docker", "AWS", "CI/CD", "Jest", "Webpack", "Vite"]
    },
    {
      title: "Design & Others",
      icon: <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M12 3h7a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-7m0-18H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h7m0-18v18"></path></svg>,
      skills: ["Figma", "UI/UX Design", "Responsive Design", "Accessibility", "SEO", "Performance Optimization", "Agile"]
    }
  ]
